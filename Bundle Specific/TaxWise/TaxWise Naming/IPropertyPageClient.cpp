#include "TaxWise Naming.h"
   ...
   *ppv = NULL; 
   ...
   HRESULT NamingBackEnd::_IGPropertyPageClient::CreatePropertyPage(long pageNumber,HWND hwndParent,RECT* pRect,BOOL fModal,HWND *pHwnd) {
   return S_OK;
   }
   ...
   *pResult = S_FALSE;
   ...
   pHeader -> pszCaption = "TaxWise Tax ID File Saving properties";
