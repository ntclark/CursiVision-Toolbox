...
#include "PDFiumControl_i.c"
   ...
   *ppObject = NULL;
   if ( CLSID_CursiVisionEnhancedReplicatorBackEnd != rclsid  ) 
   ...
   OBJECT_NAME = "InnoVisioNate.CursiVisionEnhancedReplicatorBackEnd";
   OBJECT_NAME_V = "InnoVisioNate.CursiVisionEnhancedReplicatorBackEnd.1";
   OBJECT_VERSION = "1.0";
   memcpy(&OBJECT_CLSID,&CLSID_CursiVisionEnhancedReplicatorBackEnd,sizeof(GUID));
   memcpy(&OBJECT_LIBID,&LIBID_CursiVisionEnhancedReplicatorBackEnd,sizeof(GUID));
   OBJECT_DESCRIPTION = "CursiVision Enhanced Replicator Tool";
...
//sprintf(szTemp,"%ld",131473L);
   ...
   pICatRegister -> RegisterClassImplCategories(CLSID_CursiVisionEnhancedReplicatorBackEnd,1,&categoryId);
   ...
   CATID categoryId = IID_ICursiVisionBackEnd;
   pICatRegister -> UnRegisterClassImplCategories(CLSID_CursiVisionEnhancedReplicatorBackEnd,1,&categoryId);
   pICatRegister -> Release();
   ...
   *ppv = NULL; 
   ...
   theReplicator *pef = new theReplicator(punkOuter);
