...
#include "EnhancedReplicator.h"
   ...
   HRESULT __stdcall theReplicator::Dispose(BSTR bstrOriginalFile,BSTR bstrResultFileName,BSTR graphicDataFile,BSTR dispositionSettingsFileName,BOOL isTempFile) {
