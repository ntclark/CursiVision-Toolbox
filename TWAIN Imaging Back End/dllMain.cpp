...
#include "TWAINImagingBackEnd_i.c"
#include "CursiVision_i.c"
   ...
   *ppObject = NULL;
   if ( CLSID_CursiVisionTWAINImagingBackEnd != rclsid  ) 
   ...
   OBJECT_NAME = "InnoVisioNate.CursiVisionTWAINImagingBackEnd";
   OBJECT_NAME_V = "InnoVisioNate.CursiVisionTWAINImagingBackEnd.1";
   OBJECT_VERSION = "1.0";
   memcpy(&OBJECT_CLSID,&CLSID_CursiVisionTWAINImagingBackEnd,sizeof(GUID));
   memcpy(&OBJECT_LIBID,&LIBID_CursiVisionTWAINImagingBackEnd,sizeof(GUID));
   OBJECT_DESCRIPTION = "CursiVision TWAIN Imaging Tool";
...
//      RegSetValueEx(keyHandle,NULL,0,REG_SZ,(BYTE *)szTemp,(DWORD)strlen(szModuleName));
   ...
   pICatRegister -> RegisterClassImplCategories(CLSID_CursiVisionTWAINImagingBackEnd,1,&categoryId);
   ...
   CATID categoryId = IID_ICursiVisionBackEnd;
   pICatRegister -> UnRegisterClassImplCategories(CLSID_CursiVisionTWAINImagingBackEnd,1,&categoryId);
   pICatRegister -> Release();
