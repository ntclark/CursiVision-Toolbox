...
#include "GenericBackEnd.h"
   ...
   long __stdcall GenericBackEnd::QueryInterface(REFIID riid,void **ppv) {
   ...
   *ppv = NULL;
   ...
   unsigned long __stdcall GenericBackEnd::AddRef() {
   refCount++;
   return refCount;
   }

   unsigned long __stdcall GenericBackEnd::Release() { 
   refCount--;
   if ( ! refCount ) {
      delete this;
      return 0;
