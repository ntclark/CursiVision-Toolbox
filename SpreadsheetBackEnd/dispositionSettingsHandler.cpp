...
#define OBJECT_WITH_PROPERTIES SpreadsheetBackEnd
...
{  \
   ...
   LRESULT CALLBACK SpreadsheetBackEnd::dispositionSettingsHandler(HWND hwnd,UINT msg,WPARAM wParam,LPARAM lParam) {
