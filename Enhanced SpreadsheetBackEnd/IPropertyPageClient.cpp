/*
                       ...
                       Copyright (c) 2009,2012 Nathan T. Clark
...
#include "SpreadsheetBackEnd.h"
   ...
   *ppv = NULL; 
   ...
   HRESULT SpreadsheetBackEnd::_IGPropertyPageClient::CreatePropertyPage(long pageNumber,HWND hwndParent,RECT* pRect,BOOL fModal,HWND *pHwnd) {
   return S_OK;
   }
