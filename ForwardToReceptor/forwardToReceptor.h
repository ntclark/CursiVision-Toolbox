...
#include "CursiVision_i.h"
   ...
   class forwardToReceptor : public ICursiVisionBackEnd {
   public:

      forwardToReceptor(IUnknown *pOuter);
      ~forwardToReceptor();
   ...
   private:
      ...
      HRESULT __stdcall get_Description(BSTR *p) { if ( ! p ) return E_POINTER; *p = SysAllocString(L"CursiVision Forward to Receptor Tool"); return S_OK; };
      ...
      class _ICursiVisionForwardToReceptorBackEnd : ICursiVisionForwardToReceptorBackEnd {
      public:

         _ICursiVisionForwardToReceptorBackEnd(forwardToReceptor *pp) : pParent(pp), refCount(0) {};
         ~_ICursiVisionForwardToReceptorBackEnd() {};
      ...
      private:
         ...
         forwardToReceptor *pParent;
         long refCount;

      } *pICursiVisionForwardToReceptorBackEnd;
      ...
      public:
         ...
         _IGPropertiesClient(forwardToReceptor *pp) : pParent(pp), refCount(0) {};
         ~_IGPropertiesClient() {};
      ...
      public:
         ...
         _IPropertyPage(forwardToReceptor *pp) : pParent(pp), refCount(0) {};
         ~_IPropertyPage() {};
...
//         STDMETHOD(EditProperty)(DISPID);
      ...
      public:
         ...
         _IGPropertyPageClient(forwardToReceptor *pp) : pParent(pp) {};
...
//      IPropertyPageClient
      ...
      static forwardToReceptor *pCurrentReplicatorBackEnd;
   ...
   public:
      ...
      static forwardToReceptor::_IPropertyPage *CurrentPropertyPage() { return pIPropertyPage; };
      static void CreatePropertyPage() { pIPropertyPage = new _IPropertyPage(forwardToReceptor::pCurrentReplicatorBackEnd); };
      static forwardToReceptor *CurrentObject() { return pCurrentReplicatorBackEnd; };
